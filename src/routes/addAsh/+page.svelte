<div class="w-screen flex items-center text-center">
	<div
		class="container flex flex-col md:flex-row items-center justify-center px-5 text-accent"
		style="height: 44rem;"
	>
		<div class="max-w-md">
			<p class="text-2xl md:text-3xl font-light leading-normal">Page under construction.</p>
			<a href="/" class="btn btn-primary mt-2">back to homepage</a>
		</div>
		<div>
			<svg
				id="Layer_1"
				...
				/><ellipse class="cls-7" cx="1452.5" cy="998.5" rx="153" ry="117" /><circle
					class="cls-9"
					cx="1355"
					cy="991"
					r="31.5"
